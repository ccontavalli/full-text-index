...
public:
  ...
  ulong prev2(ulong start); // gives the largest index i<=start such that IsBitSet(i)=true
  ulong next(ulong start); // gives the smallest index i>=start such that IsBitSet(i)=true
