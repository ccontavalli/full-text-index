...
static i64 *I,                  /* group array, ultimately suffix array.*/
...
static void update_group(i64 *pl, i64 *pm)
{
   i64 g;
...
static void select_sort_split(i64 *p, i64 n) {
   i64 *pa, *pb, *pi, *pn;
   i64 f, v, tmp;
...
static i64 choose_pivot(i64 *p, i64 n) {
   i64 *pl, *pm, *pn;
   i64 s;
...
static void sort_split(i64 *p, i64 n)
{
   i64 *pa, *pb, *pc, *pd, *pl, *pm, *pn;
   i64 f, v, s, t, tmp;
...
static void bucketsort(i64 *x, i64 *p, i64 n, i64 k)
{
   i64 *pi, i, c, d, g;
...
static i64 transform(i64 *x, i64 *p, i64 n, i64 k, i64 l, i64 q)
{
   i64 b, c, d, e, i, j, m, s;
   i64 *pi, *pj;
